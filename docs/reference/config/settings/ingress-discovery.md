...
rationale is in [Design: Kubernetes Ingress discovery (DNS sync phase 2)](https://github.com/Rake-Pro/go-proxy-manager/blob/main/design/ingress-discovery.md).
...
[design/ingress-discovery.md section 5a](https://github.com/Rake-Pro/go-proxy-manager/blob/main/design/ingress-discovery.md), which also holds
...
- **`locations`**: path-scoped overrides with their own upstream and chain.
  ...
  touched. See [design/ingress-discovery.md section 5](https://github.com/Rake-Pro/go-proxy-manager/blob/main/design/ingress-discovery.md).
